...
class FileTransferWizardDataSourceSpec extends CommonViewSpec {
  ...
  "FT wizard data source page" should {
    ...
    "render start page correctly" in new Setup {
      ...
      // Do we need to check the radio buttons

      document.getElementById("submit").text() shouldBe "Continue"

    }

    "render start page correctly with errors" in new Setup {
